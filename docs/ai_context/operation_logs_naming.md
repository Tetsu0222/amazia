...
| `POST /api/sales-returns` | 返品申請 |
| `PATCH /api/sales-returns/:id/approve` | 返品承認 |
| `PATCH /api/sales-returns/:id/reject` | 返品却下 |
| `PATCH /api/sales-returns/:id/refund` | 返金完了 |
...
| 返品承認 | `approve_sales_return` | `console.sales_return.approve` | `PATCH /api/sales-returns/:id/approve` |
| 返品却下 | `reject_sales_return` | `console.sales_return.approve` | `PATCH /api/sales-returns/:id/reject` |
| 返金完了 | `refund_sales_return` | `console.sales_return.approve` | `PATCH /api/sales-returns/:id/refund` |

### Market 起点

| 操作 | action | screen_name | api_name |
|------|--------|-------------|----------|
| 注文確定 | `confirm_order` | `market.checkout.confirm` | `POST /api/orders/confirm` |
| 返品申請 | `request_sales_return` | `market.purchase_history.list` | `POST /api/sales-returns` |
