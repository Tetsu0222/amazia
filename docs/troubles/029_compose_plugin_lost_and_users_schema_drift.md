...
| メモリ枯渇による SSM 応答阻害 | t3.small 一時昇格は再現性の高い切り分け手段。長期的には [phaseX-4](../design/phaseX/phaseX-4_memory_optimization_for_t3_micro.md) で Spring Heap 制限と Swap 設定により t3.micro 復帰を試みる |
